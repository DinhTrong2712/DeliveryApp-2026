  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white sticky top-0 z-10 border-b border-gray-100 px-4 py-3 flex items-center gap-3">
        ...
        <h1 className="font-bold text-gray-900">Ảnh & Ghi chú</h1>
      </div>

      <div className="px-4 pt-4 space-y-4 pb-8">
        <div className="bg-white rounded-2xl p-4 shadow-sm">
          <p className="font-medium text-gray-900 mb-3">Thêm ảnh chứng từ</p>
          ...
          {preview ? (
            ...
            <button
              ...
              className="w-full border-2 border-dashed border-gray-300 rounded-xl py-10 flex flex-col items-center gap-2 text-gray-400 min-h-[48px]"
            >
          ...
          {file && (
            <>
              <input
                ...
                className="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-base mt-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              {error && <p className="text-red-600 text-sm mt-2">{error}</p>}
              <div className="flex gap-2 mt-3">
                <button onClick={() => { setFile(null); setPreview(null) }} className="flex-1 border border-gray-300 text-gray-700 py-3 rounded-xl font-medium min-h-[48px]">
                  Chọn lại
                </button>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm">
          <p className="font-medium text-gray-900 mb-3">Ghi chú đơn hàng</p>
          <textarea
            value={note}

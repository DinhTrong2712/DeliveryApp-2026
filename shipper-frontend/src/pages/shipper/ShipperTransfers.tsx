    ...
    <ShipperLayout>
      ...
      <div className="px-4 pt-4 pb-3 flex items-start justify-between">
        ...
        <button
          ...
          className="group inline-flex items-center gap-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-700 px-3 py-1.5 rounded-lg hover:bg-orange-50 dark:hover:bg-orange-500/10 hover:border-orange-400 dark:hover:border-orange-500/60 hover:text-orange-600 dark:hover:text-orange-400 hover:shadow-sm transition-all duration-200 mt-0.5"
        >

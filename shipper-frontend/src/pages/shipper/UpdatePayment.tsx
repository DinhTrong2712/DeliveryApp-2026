  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <div className="bg-white dark:bg-gray-900 sticky top-0 z-10 border-b border-gray-100 dark:border-gray-800 px-4 py-3 flex items-center gap-3">
        ...
        <h1 className="font-bold text-gray-900 dark:text-gray-100">Cập nhật thanh toán</h1>
      </div>

      <form onSubmit={handleSubmit} className="px-4 pt-4 pb-32 space-y-4">
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 shadow-sm">
          <p className="font-medium text-gray-900 dark:text-gray-100 mb-3">Trạng thái thanh toán</p>
        ...
        {selected?.needAmount && (
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 shadow-sm">
            <label className="block font-medium text-gray-900 dark:text-gray-100 mb-2">Số tiền đã thu (VNĐ)</label>
            <input
              type="number"
              value={amountPaid}
        ...
        {selected?.needReason && (
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 shadow-sm">
            <label className="block font-medium text-gray-900 dark:text-gray-100 mb-2">Lý do chưa thu</label>
            <textarea
              value={unpaidReason}
        ...
        {selected?.needDate && (
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 shadow-sm">
            <label className="block font-medium text-gray-900 dark:text-gray-100 mb-2">Ngày hẹn</label>
            <input
              type="date"
              value={scheduledDate}
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 shadow-sm">
          <label className="block font-medium text-gray-900 dark:text-gray-100 mb-2">Ghi chú (tùy chọn)</label>
          <textarea
            value={note}

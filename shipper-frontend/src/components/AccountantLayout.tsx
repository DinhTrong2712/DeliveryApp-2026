      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-20">
        <div className="max-w-screen-2xl mx-auto px-4 md:px-6 flex items-center h-14 gap-4 md:gap-8">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <span className="font-bold text-gray-900 text-sm hidden sm:inline">Sổ Ghi Chép Giao Hàng</span>
            <span className="font-bold text-gray-900 text-sm sm:hidden">Sổ Ghi Chép</span>
          </div>
